...
- **Preview thumbnail** — from `[RESULT] Thumbnail:` line (auto-downloaded local file). You **MUST** display this image to the user so they can immediately preview the generated slides.
